# Chat / messaging with retention — `<your-github-username>`
...
- **Ingestion:** _how you load it (pipeline / bulk), throughput; TTL policy per message_
...
_Metrics and correctness checks you assert: on-disk footprint over time (does it plateau under expiry churn?), no stale hits for expired docs, query latency, GC / compaction behavior, post-restart correctness, ..._
