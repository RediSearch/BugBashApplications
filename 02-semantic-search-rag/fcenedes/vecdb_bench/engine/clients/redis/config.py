...
# Query dialect. Defaults to 4 (optimized SORTBY). Redis Flex does not support
# DIALECT 4 yet, so set REDIS_DIALECT=2 when benchmarking a Flex instance.
REDIS_DIALECT = int(os.getenv("REDIS_DIALECT", 4))
